...
foreach(pyfile ${python_test_scripts})
  ...
  add_test(${pyfile} ${PYTHON_EXECUTABLE} "${CMAKE_SOURCE_DIR}/python_examples/${pyfile}")
endforeach()

add_test(arm_to_cart_target_position_only ${PYTHON_EXECUTABLE} "${CMAKE_SOURCE_DIR}/python_examples/arm_to_cart_target.py" "--position_only")
