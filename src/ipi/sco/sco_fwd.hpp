...
class CostFromNumDiff;
typedef boost::shared_ptr<CostFromNumDiff> CostFromNumDiffPtr;
class ConstraintFromNumDiff;
typedef boost::shared_ptr<ConstraintFromNumDiff> ConstraintFromNumDiffPtr;
class Optimizer;
