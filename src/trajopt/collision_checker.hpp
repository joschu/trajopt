...
public:
  ...
  virtual void MultiCastVsAll(Configuration& rad, const vector<KinBody::LinkPtr>& links, const vector<DblVec>& multi_joints, vector<Collision>& collisions, short filterMask=KinBodyFilter) {throw std::runtime_error("not implemented");}
